...
public class TrialApplication implements ApplicationRunner {
	...
	public TrialApplication(DataGenerationService dataGenerationService, EventSimulation eventSimulation, EventRepository eventRepository, AthleteRepository athleteRepository) {
...
//		System.out.println(athleteRepository.findAthletesByEvent(dataGenerationService.getEventById(1)));
//		System.out.println(dataGenerationService.highestMedalAthlete(dataGenerationService.getEventById(1)));
